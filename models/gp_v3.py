...
class GPR(nn.Module):
    ...
    def __init__(self, kernel='Hybrid', jitter=1e-5, dim_cont1=1, dim_cont2=1, dim_cat1=9, dim_cat2=9):
        super().__init__() 
        ...
        if kernel == 'RBF':
            ...
            self.kernel = KernelHybrid(jitter, dim_cont=dim_cont1)
        elif kernel == 'Hybrid2':
            self.kernel = KernelHybrid2(jitter, dim_cont1=dim_cont1, dim_cont2=dim_cont2)
        elif kernel == 'Hybrid3':
            self.kernel = KernelHybrid3(jitter, dim_cont1=dim_cont1, dim_cont2=dim_cont2, dim_cat1=dim_cat1, dim_cat2=dim_cat2)
        else:
